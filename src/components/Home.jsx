...
function Home() {
    ...
    return(
        <>
        <div><img src="/assets/img/guia-pratico-recicalagem.jpg" alt="Simbolo da reciclagem" id="bg-img"/></div>
        <div className="container-text">
            ...
            <div><a href="#section2" className="btn-home">Conheça o site</a></div>
        </div>
        </>
    )
}
